...
RSpec.describe ::NewLegalDocument::Document, type: :service do
  context 'New Legal Document' do
    ...
    describe 'perform' do
      it 'create a new legal document and set previous to offline' do
        ...
        expect(LegalDocument.count).to eq(1)
        expect(new_document.reload.online).to be true
      end
    end
  end

  context 'Legal Document already exist' do
